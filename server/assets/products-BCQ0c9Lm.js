const sofa = "/assets/p-sofa-CY6ZNZRk.jpg";
const chair = "/assets/p-chair-7_quF2KI.jpg";
const bed = "/assets/p-bed-CitMbnVI.jpg";
const dining = "/assets/p-dining-PrbDhq5O.jpg";
const wardrobe = "/assets/p-wardrobe-BsKbYTyg.jpg";
const desk = "/assets/p-desk-CUBk4JVq.jpg";
const img = { sofa, chair, bed, dining, wardrobe, desk };
const products = [
  {
    id: "p1",
    slug: "emerald-chesterfield-sofa",
  ...
  },
  {
    ...
    title: "Walnut Platform Bed — King",
  ...
  {
    id: "p5",
    slug: "monolith-wardrobe",
    title: "Monolith Wardrobe",
